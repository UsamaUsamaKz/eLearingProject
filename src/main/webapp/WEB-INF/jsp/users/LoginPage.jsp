...
<c:url var="postloginUrl" value="home" />
...
<head>
	...
	<!-- Meta tag Keywords -->
	<!-- css files -->
	<link rel="stylesheet" href="<c:url value="/resources/css/styleLogin.css"/>" type="text/css" media="all" />
	<!-- Style-CSS -->
...
<body>
	<div class="video-w3l" data-vide-bg="/resources/video/1">
		<!-- title -->
		<h1>
	...
	<!-- Video js -->
	<script type="text/javascript" src="<c:url value="/resources/js/jquery-vide.min.js"/>"></script>
	<!-- //Video js -->
