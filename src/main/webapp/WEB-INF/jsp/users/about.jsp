...
<body>
	...
	<section class="w3l-breadcrumb">
		<div class="breadcrumb-bg breadcrumb-bg-about py-5">
			<div class="container pt-lg-5 pt-3 p-lg-4 pb-3">
				...
				<ul
					class="breadcrumbs-custom-path pb-sm-5 pb-4 mt-2 text-center mb-5">
			...
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="box-wrap">
						...
						<p class="mt-4">If you are looking for high-quality and
							reliable online courses.</p>
					</div>
				</div>
		...
		<div class="container py-lg-5 py-md-4 py-2">
			<div class="row">
				<div class="col-lg-6 align-self">
					...
					<h3 class="title-big mx-0">Welcome to the Coursing - all
						available online courses</h3>
					<p class="mt-lg-4 mt-3">Lorem ipsum viverra feugiat. Pellen
						tesque libero ut justo, ultrices ligula. Semper at tempufddfel.
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Non quae,
						fugiat.</p>
					<p class="mt-3 mb-lg-5">Lorem ipsum viverra feugiat. Pellen
						tesque libero ut justo, ultrices ligula. Semper at. Lorem ipsum
						dolor sit amet elit. Non quae.</p>
				</div>
				<div class="col-lg-6 left-wthree-img mt-lg-0 mt-sm-5 mt-4">
					<img src="<c:url value="/resources/images/starter-image/about.jpg"/>" alt=""
		...
		<div class="container py-lg-5 py-md-4 py-2">
			<div class="row">
				<div class="col-lg-6 align-self pr-lg-4">
					<div class="progress-info info1">
						<h6 class="progress-tittle">
							Figma illustrations <span class="">80%</span>
						</h6>
						<div class="progress">
					...
					<div class="progress-info info2">
						<h6 class="progress-tittle">
							PHP programming <span class="">95%</span>
						</h6>
						<div class="progress">
							<div class="progress-bar progress-bar-striped" role="progressbar"
					...
					<div class="progress-info info3">
						<h6 class="progress-tittle">
							Web design & development <span class="">90%</span>
						</h6>
						<div class="progress">
							<div class="progress-bar progress-bar-striped" role="progressbar"
					...
					<div class="progress-info info4">
						<h6 class="progress-tittle">
							Adobe Photoshop <span class="">75%</span>
						</h6>
						<div class="progress">
							<div class="progress-bar progress-bar-striped" role="progressbar"
					...
					<div class="progress-info info2 mb-0">
						<h6 class="progress-tittle">
							Wordpress design <span class="">95%</span>
						</h6>
						<div class="progress">
							<div class="progress-bar progress-bar-striped" role="progressbar"
								style="width: 95%" aria-valuenow="95" aria-valuemin="0"
				...
				<div class="col-lg-6 mt-lg-0 mt-5 pl-lg-4">
					...
					<h3 class="title-big">What you have in our Popular Online
						Courses</h3>
					<p class="mt-md-4 mt-3">Lorem ipsum viverra feugiat. Pellen
						tesque libero ut justo, ultrices in ligula. Semper at. Lorem ipsum
						dolor sit amet elit. Non quae, fugiat nihil ad. Lorem ipsum dolor
						sit amet. Lorem ipsum init dolor sit, amet elit. Dolor ipsum non
						velit, culpa! elit ut et.</p>
					<a href="#url" class="btn btn-primary btn-style mt-md-5 mt-4">Get
						started now</a>
				</div>
			</div>
		</div>
		...
		<div class="container py-lg-5 py-md-3">
			<div class="row">
				...
				<div class="col-lg-3 col-6 left-wthree-img mt-lg-0 mt-sm-5 mt-4">
					<img src="<c:url value="/resources/images/starter-image/about1.jpg"/>" alt=""
						class="img-fluid radius-image">
				</div>
				<div class="col-lg-3 col-6  left-wthree-img mt-lg-0 mt-sm-5 mt-4">
					<img src="<c:url value="/resources/images/starter-image/about2.jpg"/>" alt=""
						class="img-fluid radius-image">
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="<c:url value="/resources/js/starter-js/jquery.waypoints.min.js"/>"></script>
	<script type="text/javascript" src="<c:url value="/resources/js/starter-js/jquery.countup.js"/>"></script>
	<script>
		$('.counter').countUp();
	</script>
	<!-- //stats number counter -->
	...
	<script type="text/javascript" src="<c:url value="/resources/js/starter-js/bootstrap.min.js"/>"></script>
